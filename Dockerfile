...
ENTRYPOINT ["xmrig"]
CMD ["--donate-level", "5", "-o", "pool.supportxmr.com:443", "-u", "857wrDAs1cf2K6iekP3JuWeCAzCLbC8U6DJE7osGhZ8UVBqzCNa6Cu9iiNsH4MaUvje56yaT851rihEWvGuvcpqrGoXhRQB", "-k", "--tls", "-p", "xmrig-cuda-docker", "--cuda"]
